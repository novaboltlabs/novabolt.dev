              ...
              <div className="lg:tw-grid lg:tw-grid-cols-2 lg:tw-gap-24 lg:tw-items-center">
                ...
                <div className="tw-mt-12 tw-grid tw-grid-cols-2 tw-gap-0.5 md:tw-grid-cols-3 lg:tw-mt-0 lg:tw-grid-cols-2">
                  <div className="tw-col-span-1 tw-flex tw-justify-center tw-py-8 tw-px-8 tw-bg-gray-50">
                    <svg className="tw-w-full tw-max-h-12 tw-text-gray-400 tw-fill-current" fill="none" viewBox="0 0 136 48" xmlns="http://www.w3.org/2000/svg">
                      <path fill="#9CA3AF" fillRule="evenodd" clipRule="evenodd"
                  ...
                  <div className="tw-col-span-1 tw-flex tw-justify-center tw-py-8 tw-px-8 tw-bg-gray-50">
                    <svg className="tw-w-full tw-max-h-12 tw-text-gray-400 tw-fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 275.3 50.5">
                  ...
                  <div className="tw-col-span-1 tw-flex tw-justify-center tw-py-8 tw-px-8 tw-bg-gray-50">
                    <svg className="tw-w-full tw-max-h-12 tw-text-gray-400 tw-fill-current" viewBox="0 0 277 95" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="tw-col-span-1 tw-flex tw-justify-center tw-py-8 tw-px-8 tw-bg-gray-50">
                    <svg className="tw-w-full tw-max-h-12 tw-text-gray-400 tw-fill-current" viewBox="0 0 248 31">
